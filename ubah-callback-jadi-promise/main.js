...
const getProvincesPromised = util.promisify(getProvinces);

getProvincesPromised(false)
  .then((res) => console.log(res))
  .catch((err) => console.log(err.message));

getProvincesPromised(true)
  .then((res) => console.log(res))
  .catch((err) => console.log(err.message));

module.exports = { getProvinces: getProvincesPromised };
